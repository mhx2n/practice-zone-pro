  ...
  // 12. Info table (Campus Capsule style)
  {
    ...
    doc: {
      ...
      layers: [
        ...
        txt({ x: 580, y: 780, w: 420, h: 60, text: " শুধু লিখিত", fontFamily: "'Hind Siliguri', sans-serif", fontSize: 28, color: "#1d4ed8", bg: "#dbeafe", padding: 12, radius: 24, align: "center", fontWeight: 700 }),
